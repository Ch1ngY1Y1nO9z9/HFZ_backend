    ...
    <section class="text-gray-600 body-font px-8 py-24 min-h-screen">
        <div class="container mx-auto flex px-5 items-center justify-center flex-col">
            ...
            <div class="text-center lg:w-2/3 w-full">
              <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium @if(Session::has('darkMode')) text-gray-100 @else text-gray-900 @endif">{{$news->title}}</h1>
...
<script>
    $('.lights').click(function(){
        if($('body').hasClass('bg-white')){
          ...
          $('.title-font').removeClass('bg-gray-100');
          $('.title-font').addClass('bg-gray-900');
