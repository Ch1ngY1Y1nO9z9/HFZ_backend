        ...
        <section class="bg-white py-8 pt-24 min-h-screen">
            <div class="container px-5 mx-auto flex flex-wrap">
                ...
                <div class="flex flex-col text-center w-full mb-10">
                    <h1 class="sm:text-5xl text-4xl font-medium title-font mb-4 text-gray-900">Stream {{$stream_id}} match result</h1>
                </div>
                ...
                <div class="flex flex-col text-center w-full pt-24 mb-10">
                    <h1 class="sm:text-4xl text-3xl font-medium title-font mb-4 text-gray-900">Stream songs</h1>
                      ...
                      @foreach ($songs_list as $song)
                        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
                            <div class="w-full border-gray-200 border p-4 rounded-lg">
                                <p class="text-gray-900 text-xl md:text-2xl">Played at Game {{$song->played_at}}</p>
